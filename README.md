...
| ------------------------------------------------------------------------------------------------------------------------------------------------------------ | ----------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | ---------------------------- | ------------------------------------------------------------------------ |
| [**Pineapple E-Commerce**](https://github.com/emanuelefavero/pineapple-ecommerce)                                                                            | An iPhone ecommerce built with **Next.js**, **Sanity** and **Stripe**                                                                                                         | Next.js / Sanity / Stripe    | [Website](https://pineapple-ecommerce.vercel.app/)                       |
...
| [**ChatGPT Clone**](https://github.com/emanuelefavero/chatgpt-clone)                                                                                         | A clone of the OpenAI chatGPT website that instead uses the GPT API                                                                                                           | Next.js, OpenAI API          | [Website](https://chatgpt-clone-ten-eta.vercel.app/chat)                 |
